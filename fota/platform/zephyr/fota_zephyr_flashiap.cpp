 ...
 */
int32_t fota_zephyr_flashiap_active_init(void)
{
 ...
 */
int32_t fota_zephyr_flashiap_active_read(uint8_t *buffer,
                                         uint32_t address,
                                         uint32_t size)
{
 ...
 *  @return 0 on success or a negative error code on failure
 */
int32_t fota_zephyr_flashiap_init(void)
{
    return fota_zephyr_flashiap_active_init();
}
 ...
 *  @return         0 on success, negative error code on failure
 */
int32_t fota_zephyr_flashiap_read(uint8_t *buffer,
                                  uint32_t address,
                                  uint32_t size)
{
    return fota_zephyr_flashiap_active_read(buffer, address, size);
}
...
int32_t fota_zephyr_flashiap_candidate_init(void)
{
    return FLASH_CANDIDATE_OBJ.init();
}

int32_t fota_zephyr_flashiap_candidate_erase(uint32_t address, uint32_t size)
{
    return FLASH_CANDIDATE_OBJ.erase(address, size);
}

int32_t fota_zephyr_flashiap_candidate_program(const uint8_t *buffer,
                                               uint32_t address,
                                               uint32_t size)
{
...
int32_t fota_zephyr_flashiap_candidate_read(uint8_t *buffer,
                                            uint32_t address,
                                            uint32_t size)
{
...
uint32_t fota_zephyr_flashiap_candidate_get_page_size(void)
{
    return FLASH_CANDIDATE_OBJ.get_page_size();
}

uint32_t fota_zephyr_flashiap_candidate_get_sector_size(uint32_t address)
{
...
uint32_t fota_zephyr_flashiap_candidate_get_flash_size(void)
{
    return FLASH_CANDIDATE_OBJ.get_flash_size();
}

uint32_t fota_zephyr_flashiap_candidate_get_flash_start(void)
{
